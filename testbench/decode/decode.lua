...
inputs["tb.fetch_in_valid_i"] = fetch_in_valid_i
inputs["tb.fetch_in_instr_i"] = fetch_in_instr_i
inputs["tb.fetch_in_pc_i"] = fetch_in_pc_i
inputs["tb.fetch_in_fault_fetch_i"] = fetch_in_fault_fetch_i
inputs["tb.fetch_in_fault_page_i"] = fetch_in_fault_page_i
inputs["tb.fetch_out_accept_i"] = fetch_out_accept_i
inputs["tb.squash_decode_i"] = squash_decode_i

outputs = {}
outputs["tb.fetch_in_accept_o"] = fetch_in_accept_o
outputs["tb.fetch_out_valid_o"] = fetch_out_valid_o
outputs["tb.fetch_out_instr_o"] = fetch_out_instr_o
outputs["tb.fetch_out_pc_o"] = fetch_out_pc_o
outputs["tb.fetch_out_fault_fetch_o"] = fetch_out_fault_fetch_o
outputs["tb.fetch_out_fault_page_o"] = fetch_out_fault_page_o
outputs["tb.fetch_out_instr_exec_o"] = fetch_out_instr_exec_o
outputs["tb.fetch_out_instr_lsu_o"] = fetch_out_instr_lsu_o
outputs["tb.fetch_out_instr_branch_o"] = fetch_out_instr_branch_o
outputs["tb.fetch_out_instr_mul_o"] = fetch_out_instr_mul_o
outputs["tb.fetch_out_instr_div_o"] = fetch_out_instr_div_o
outputs["tb.fetch_out_instr_csr_o"] = fetch_out_instr_csr_o
outputs["tb.fetch_out_instr_rd_valid_o"] = fetch_out_instr_rd_valid_o
outputs["tb.fetch_out_instr_invalid_o"] = fetch_out_instr_invalid_o
